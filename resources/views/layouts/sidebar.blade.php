<aside class="left-sidebar" data-sidebarbg="skin6">
    ...
    <div class="scroll-sidebar" data-sidebarbg="skin6">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                <li class="sidebar-item {{ $activePage == 'dashboard' ? 'selected' : '' }}"> <a class="sidebar-link sidebar-link" href="index.html"
                ...
                <li class="sidebar-item {{ $activePage == 'form' || $activePage == 'form2' ? 'selected' : '' }}"> <a class="sidebar-link has-arrow {{ $activePage == 'form' || $activePage == 'form2' ? 'active' : '' }}" href="javascript:void(0)"
                        aria-expanded="false"><i data-feather="file-text" class="feather-icon"></i><span
                            class="hide-menu">Forms </span></a>
                    <ul aria-expanded="false" class="collapse {{ $activePage == 'form' || $activePage == 'form2' ? 'in' : '' }} first-level base-level-line">
                        <li class="sidebar-item {{ $activePage == 'form' ? 'active' : '' }}"><a href="form-inputs.html" class="sidebar-link {{ $activePage == 'form' ? 'active' : '' }}"><span
